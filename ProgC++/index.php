 ...
 <div class="container">
 	<div class="row">
 		<div class="col-sm-12">
            <center>
 			   <div class="wrapper">
			        <div class="title">Learn to Code with C++</div>
			        <div class="form">
                ...
                $.ajax({
                    ...
                    success: function(result){
                       $replay = '<div class="bot-inbox inbox"><div class="icon"><img src="../ImageLogo/bot.png" class="icon"></div><div class="msg-header"><p>'+ result +'</p></div></div>';
                        // $replay = '<div class="bot-inbox inbox"><div class="icon"><img src="../ImageLogo/C++.png" class="icon"></div><div class="msg-header"><p>'+ result +'</p></div></div>';
                        $(".form").append($replay);
