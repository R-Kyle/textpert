...
$display = mysqli_query($con, "SELECT * FROM phpbot WHERE id='$itemid' ");  
...
if (isset($_POST['submit'])) {
 ...
 $update = mysqli_query($con,"UPDATE phpbot SET Queries='$query', Replies='$reply', Sample_Code='$samplecode' WHERE id='$itemid' ");
...
<head>
    ...
    <title>PHP Edit Response list</title>
</head>
<body>
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 row">
                        <h4 class="page-title">PHP Edit Response list</h4>
                        <?php echo $msg; ?>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
                    ...
                    <div class="card">
                      <div class="card-body bg-dark" style="color:white;">
                       ...
                       <form Method="POST" class="row">
                        ...
                        <div class="col-sm-8"><h1 name="language">PHP</h1></div>
