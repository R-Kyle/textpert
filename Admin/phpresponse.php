...
if (strlen( $_SESSION['aid']==0)) {
  ...
  if(isset($_GET['deleteid']))
  {
    ...
    $query=mysqli_query($con,"DELETE from phpbot where id='$rowid'");
    header("Location:phpresponse.php");
  }
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 row">
                        <h4 class="page-title">PHP Response list</h4>
                            ...
                            <div class="card-body">
                                <form method="POST" class="form-horizontal form-material">
                                    ...
                                    <?php 
                                        ...
                                        $ret=mysqli_query($con,"SELECT * FROM phpbot");
                                        ...
                                        $getQuery = "SELECT * FROM phpbot LIMIT " . $initial_page . ',' . $limit;
                                    ...
                                    ?>
                                            <tr>
                                              ...
                                              <td class="col-1"><a href="phpeditresponse.php?itemid=<?php echo $row['id'];?>" class="btn btn-warning form-control"><span class="fa fa-edit" style="color:white; font-size:20px;"></span></a></td>
                                              <td class="col-1"><a href="phpresponse.php?deleteid=<?php echo $row['id'];?>" class="btn btn-danger form-control"><span class="fa fa-trash" style="color:white; font-size:20px;"></span></a></td>
                                ...
                                <div class="clearfix">
                                    ...
                                    <?php for($page_number = 1; $page_number<= $total_pages; $page_number++) {   ?>                 
                                        <li class="page-item active">
                                            <a href = "phpresponse.php?page=<?php echo $page_number; ?>" class="page-item page-link active" ><?php echo $page_number; ?></a> 
                                        </li>&nbsp &nbsp
                                    <?php } ?>
